...
`ifndef RELU_REFERENCE_MODEL_SV
`define RELU_REFERENCE_MODEL_SV

class relu_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(relu_reference_model)
