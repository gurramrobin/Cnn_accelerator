...
TOOLCHAIN += --sysroot=C:/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/maxpool.cpp_pre.cpp.tb.o : maxpool.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling maxpool.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
