...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.maxpool.autotvin_in_stream_V_data_V.dat"
         "c.maxpool.autotvin_in_stream_V_keep_V.dat"
         "c.maxpool.autotvin_in_stream_V_strb_V.dat"
         "c.maxpool.autotvin_in_stream_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.maxpool.autotvout_out_stream_V_data_V.dat"
         "rtl.maxpool.autotvout_out_stream_V_keep_V.dat"
         "rtl.maxpool.autotvout_out_stream_V_strb_V.dat"
         "rtl.maxpool.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
