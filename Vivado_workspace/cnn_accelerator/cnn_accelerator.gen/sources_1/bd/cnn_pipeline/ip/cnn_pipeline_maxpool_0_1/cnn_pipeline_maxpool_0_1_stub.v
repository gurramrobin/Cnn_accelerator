...
//               c:/CHINNA/Vivado_workspace/cnn_accelerator/cnn_accelerator.gen/sources_1/bd/cnn_pipeline/ip/cnn_pipeline_maxpool_0_1/cnn_pipeline_maxpool_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "cnn_pipeline_maxpool_0_1,maxpool,{}" *) (* CORE_GENERATION_INFO = "cnn_pipeline_maxpool_0_1,maxpool,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=maxpool,x_ipVersion=1.0,x_ipCoreRevision=2114649006,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "maxpool,Vivado 2025.2" *) (* hls_module = "yes" *) 
module cnn_pipeline_maxpool_0_1(ap_clk, ap_rst_n, ap_done, ap_idle, ap_ready, 
