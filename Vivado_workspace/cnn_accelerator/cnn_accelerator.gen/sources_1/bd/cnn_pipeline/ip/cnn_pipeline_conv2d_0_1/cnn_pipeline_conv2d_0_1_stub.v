...
//               c:/CHINNA/Vivado_workspace/cnn_accelerator/cnn_accelerator.gen/sources_1/bd/cnn_pipeline/ip/cnn_pipeline_conv2d_0_1/cnn_pipeline_conv2d_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "cnn_pipeline_conv2d_0_1,conv2d,{}" *) (* CORE_GENERATION_INFO = "cnn_pipeline_conv2d_0_1,conv2d,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=conv2d,x_ipVersion=1.0,x_ipCoreRevision=2114648993,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "conv2d,Vivado 2025.2" *) (* hls_module = "yes" *) 
module cnn_pipeline_conv2d_0_1(ap_clk, ap_rst_n, ap_done, ap_idle, ap_ready, 
  ap_start, in_stream_TDATA, in_stream_TKEEP, in_stream_TLAST, in_stream_TREADY, 
  in_stream_TSTRB, in_stream_TVALID, weight_stream_TDATA, weight_stream_TKEEP, 
  weight_stream_TLAST, weight_stream_TREADY, weight_stream_TSTRB, weight_stream_TVALID, 
  bias, out_stream_TDATA, out_stream_TKEEP, out_stream_TLAST, out_stream_TREADY, 
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 ap_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF in_stream:weight_stream:out_stream, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 199998001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN cnn_pipeline_zynq_ultra_ps_e_0_1_pl_clk0, INSERT_VIP 0" *) input ap_clk /* synthesis syn_isclock = 1 */;
