set moduleName conv2d_Pipeline_WRITE_OUTPUT
set isTopModule 0
...
set cdfgNum 7
set C_modelName {conv2d_Pipeline_WRITE_OUTPUT}
...
set C_modelArgList {
	...
	{ output_4_reload int 16 regular  }
	{ output_5_reload int 16 regular  }
	{ output_6_reload int 16 regular  }
	{ output_7_reload int 16 regular  }
	{ output_8_reload int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_4_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "output_5_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "output_6_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "output_7_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "output_8_reload", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_reload sc_in sc_lv 16 signal 0 } 
	{ output_1_reload sc_in sc_lv 16 signal 1 } 
	{ output_2_reload sc_in sc_lv 16 signal 2 } 
	{ output_3_reload sc_in sc_lv 16 signal 3 } 
	{ output_4_reload sc_in sc_lv 16 signal 4 } 
	{ output_5_reload sc_in sc_lv 16 signal 5 } 
	{ output_6_reload sc_in sc_lv 16 signal 6 } 
	{ output_7_reload sc_in sc_lv 16 signal 7 } 
	{ output_8_reload sc_in sc_lv 16 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_4_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_4_reload", "role": "default" }} , 
 	{ "name": "output_5_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_5_reload", "role": "default" }} , 
 	{ "name": "output_6_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_6_reload", "role": "default" }} , 
 	{ "name": "output_7_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_7_reload", "role": "default" }} , 
 	{ "name": "output_8_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_8_reload", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	output_4_reload { ap_none {  { output_4_reload in_data 0 16 } } }
	output_5_reload { ap_none {  { output_5_reload in_data 0 16 } } }
	output_6_reload { ap_none {  { output_6_reload in_data 0 16 } } }
	output_7_reload { ap_none {  { output_7_reload in_data 0 16 } } }
	output_8_reload { ap_none {  { output_8_reload in_data 0 16 } } }
