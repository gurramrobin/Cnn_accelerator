...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.conv2d.autotvin_in_stream_V_data_V.dat"
         "c.conv2d.autotvin_in_stream_V_keep_V.dat"
         "c.conv2d.autotvin_in_stream_V_strb_V.dat"
         "c.conv2d.autotvin_in_stream_V_last_V.dat"
         "c.conv2d.autotvin_weight_stream_V_data_V.dat"
         "c.conv2d.autotvin_weight_stream_V_keep_V.dat"
         "c.conv2d.autotvin_weight_stream_V_strb_V.dat"
         "c.conv2d.autotvin_weight_stream_V_last_V.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.conv2d.autotvout_out_stream_V_data_V.dat"
         "rtl.conv2d.autotvout_out_stream_V_keep_V.dat"
         "rtl.conv2d.autotvout_out_stream_V_strb_V.dat"
         "rtl.conv2d.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
