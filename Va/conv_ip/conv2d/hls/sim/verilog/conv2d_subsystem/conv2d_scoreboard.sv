...
`ifndef CONV2D_SCOREBOARD__SV                                                       
    ...
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.conv2d.autotvout_out_stream_V_data_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TKEEP_wrapc  "../tv/rtldatafile/rtl.conv2d.autotvout_out_stream_V_keep_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TSTRB_wrapc  "../tv/rtldatafile/rtl.conv2d.autotvout_out_stream_V_strb_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TLAST_wrapc  "../tv/rtldatafile/rtl.conv2d.autotvout_out_stream_V_last_V.dat"
    ...
    class conv2d_scoreboard extends uvm_component;                                        
        ...
        virtual function void write_svr_master_bias(svr_transfer#(16) tr);
            `uvm_info(this.get_full_name(), "port bias collected one pkt", UVM_DEBUG);          
        endfunction
        ...
        virtual function void write_svr_master_weight_stream(svr_transfer#(21) tr);
            `uvm_info(this.get_full_name(), "port weight_stream collected one pkt", UVM_DEBUG);          
        endfunction
