...
//
//==============================================================
`ifndef MAXPOOL_CONFIG__SV                        
    `define MAXPOOL_CONFIG__SV                    
                                                            
    class maxpool_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(maxpool_config)         
        ...
        function new (string name = "maxpool_config");
            super.new(name);                                
