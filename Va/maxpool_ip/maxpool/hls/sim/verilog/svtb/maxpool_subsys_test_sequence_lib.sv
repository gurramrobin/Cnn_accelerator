...
//
//==============================================================
`ifndef MAXPOOL_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define MAXPOOL_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
    `define AUTOTB_TVIN_in_stream_in_stream_TDATA  "../tv/cdatafile/c.maxpool.autotvin_in_stream_V_data_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TKEEP  "../tv/cdatafile/c.maxpool.autotvin_in_stream_V_keep_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TSTRB  "../tv/cdatafile/c.maxpool.autotvin_in_stream_V_strb_V.dat" 
    `define AUTOTB_TVIN_in_stream_in_stream_TLAST  "../tv/cdatafile/c.maxpool.autotvin_in_stream_V_last_V.dat" 
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class maxpool_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "maxpool_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(maxpool_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(maxpool_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(maxpool_reference_model)::get(p_sequencer,"", "refm", refm))
                ...
                begin
                    fork
                        begin
                            ...
                            if( refm.maxpool_cfg.port_in_stream_cfg.prt_type == AP_VLD ) wait(refm.misc_if.tb2dut_ap_start === 1'b1);
