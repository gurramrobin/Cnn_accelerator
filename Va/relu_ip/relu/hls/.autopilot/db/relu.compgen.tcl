...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler relu_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
...
set InstName relu_flow_control_loop_pipe_U
set CompName relu_flow_control_loop_pipe
