...
# 
# ==============================================================
set ::env(PATH) "C:/2025.2/Vitis/win64/tools/fpo_v7_1;$::env(PATH)"
set ::env(PATH) "C:/2025.2/Vitis/win64/tools/fft_v9_1;$::env(PATH)"
set ::env(PATH) "C:/2025.2/Vitis/win64/tools/fir_v7_0;$::env(PATH)"
set ::env(PATH) "C:/2025.2/Vitis/win64/tools/dds_v6_0;$::env(PATH)"
set ::env(PATH) "C:/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt/bin;$::env(PATH)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "relu.autotvin.dat"
	set constFileTvOut       "relu.autotvout.dat"
	set constFileHdlTvIn     "relu.autohdltvin.dat"
	set constFileHdlTvOut    "relu.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
