...
//
//==============================================================
`ifndef RELU_SCOREBOARD__SV                                                       
    `define RELU_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.relu.autotvout_out_stream_V_data_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TKEEP_wrapc  "../tv/rtldatafile/rtl.relu.autotvout_out_stream_V_keep_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TSTRB_wrapc  "../tv/rtldatafile/rtl.relu.autotvout_out_stream_V_strb_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TLAST_wrapc  "../tv/rtldatafile/rtl.relu.autotvout_out_stream_V_last_V.dat"
    ...
    class relu_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(relu_scoreboard)                                     
